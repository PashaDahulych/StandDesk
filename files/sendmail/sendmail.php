<?php
	...
	$mail->Username   = 'pavlodahulich@gmail.com';                     //SMTP username
	$mail->Password   = 'swprieduafgfvxpk';                               //SMTP password
	...
	//Від кого лист
	$mail->setFrom('pavlodahulich@gmail.com', 'StandDesk форма замовлення'); // Вказати потрібний E-mail
	//Кому відправити
	$mail->addAddress('pavlodahulich@gmail.com'); // Вказати потрібний E-mail
	//Тема листа
