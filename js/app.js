(() => {
    ...
    //! Жеки код
        ...
        window.addEventListener("scroll", (() => {
            const tabs = document.querySelector("[data-tabs]:not(._tab-init)");
            if (!tabs || tabsVisible) return;
            const tabsRect = tabs.getBoundingClientRect();
            if (tabsRect.top < window.innerHeight) {
                tabsVisible = true;
                tabs.classList.add("_tab-init");
                tabs.click();
            }
        }));
    }
    ...
    let formValidate = {
        ...
        phoneTest(formRequiredItem) {
            return !/^(\+?380\d{9}|\d{10}|\+\d{12})$/.test(formRequiredItem.value);
        },
    ...
    function initSliders() {
        if (document.querySelector(".testination__slider")) new swiper_core_Swiper(".testination__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".testination__arr-left.swiper-button-prev",
                nextEl: ".testination__arr-right.swiper-button-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".galery__slider")) {
            const galerySlider = new swiper_core_Swiper(".galery__slider", {
                ...
                navigation: {
                    prevEl: ".galery__arr-left.swiper-button-prev",
                    nextEl: ".galery__arr-right.swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.1,
                ...
                on: {
                    click: function(event) {
                        ...
                        if (!activeSlide.classList.contains("swiper-slide-active")) {
                            const clickedSlideIndex = event.target.getAttribute("data-swiper-slide-index");
            ...
            function sliderMouseSlideInit() {
                document.addEventListener("mousemove", (function(e) {
                    ...
                    if (targetElement.closest("[data-mousemove-swipe]")) {
                        ...
                        const sliderPath = Math.round(sliderWidth / galerySlider.slides.length);
                        const sliderSlide = Math.floor(sliderMousePos / sliderPath);
                        galerySlider.slideTo(sliderSlide);
                    }
                }));
            }
            galerySlider.on("mouseleave", (function() {
                document.removeEventListener("mousemove", sliderMouseSlideInit);
            }));
    ...
    script_forms.forEach((form => {
        form.addEventListener("focusin", (event => {
            ...
            if (target.tagName === "INPUT") {
                ...
                const labelContainer = label.closest(".form__line");
                if (labelContainer) if (target.value.trim() === "") labelContainer.classList.add("label-focus");
            }
        }));
        form.addEventListener("focusout", (event => {
            ...
            if (target.tagName === "INPUT") {
                ...
                if (target.value.trim() === "") {
                    ...
                    const labelContainer = label.closest(".form__line");
                    if (labelContainer) labelContainer.classList.remove("label-focus");
                }
            }
        }));
            ...
            input.addEventListener("focusin", (event => {
                ...
                if (target.value.trim() === "") {
                    ...
                    if (label) {
                        label.classList.add("label-focus");
                        const labelContainer = label.closest(".form__line");
                        if (labelContainer) labelContainer.classList.add("label-focus");
                    }
                }
            }));
    ...
    //! Input Mask - good work -додає клас _form-error до обгортки і до інпута
        ...
        let mask = null;
        const formLine = input.closest(".form__line--number");
        function updateValidation() {
            if (mask) {
                const maskedValue = mask.value;
                const maskLength = mask.mask.length;
                formLine.classList.remove("_form-error");
                input.classList.remove("_form-error");
                if (maskedValue.length == maskLength) {
                    input.classList.add("_form-ok");
                    formLine.classList.add("_form-ok");
                } else {
                    input.classList.remove("_form-ok");
                    formLine.classList.remove("_form-ok");
                    formLine.classList.add("_form-error");
